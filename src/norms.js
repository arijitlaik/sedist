...
var NormalDistibuton = function (mean, std) {
    var std = std == undefined ? 1 : std;
    var mean = mean == undefined ? 0 : mean;
...
var ArithmeticProbabilityPaper = function (yu, yl) {
